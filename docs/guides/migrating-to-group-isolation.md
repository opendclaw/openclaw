...
Expected: _"I don't have any information about property deeds."_
...
Expected: _"I don't have any information about Project Nightingale."_
...
Once group isolation is working, consider adding **Access Control** to enforce file boundaries, tool restrictions, and skill filtering:

- See [Migration Guide: Adding Access Control](./migrating-to-group-access-control.md) for step-by-step instructions
- Start with the **Vault** group for maximum security
- Add restrictions incrementally with testing between changes
